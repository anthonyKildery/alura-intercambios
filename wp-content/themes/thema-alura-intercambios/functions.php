...
function alura_intercambios_adicionando_sripts() {
    $textosBanner = pegandoTextosBenner();
...
add_action( 'wp_enqueue_scripts', 'alura_intercambios_adicionando_sripts' );
